...
from . import motionformer_performer_helper as performer_helper
from . import motionformer_orthoformer_helper as orthoformer_helper
from . import motionformer_nystrom_helper as nystrom_helper
...
def load_pretrained(
    ...
    # Load state dict
    assert(f"{cfg.MOTIONFORMER.PRETRAINED_WEIGHTS} not in [vit_1k, vit_1k_large]")
    state_dict = torch.hub.load_state_dict_from_url(url=default_cfgs[cfg.MOTIONFORMER.PRETRAINED_WEIGHTS])
